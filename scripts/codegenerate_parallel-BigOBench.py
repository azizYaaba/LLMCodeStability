...
def main(
    ...
    *models: str,
    temperatures: str = "0, 0.2, 0.4, 0.6, 0.8, 1, 1.2, 1.4, 1.6, 1.8, 2.0",
    ...
    for model in models:
        for temperature in temperature_list:
            ...
            output_file = f"results/BigOBench/{subdir}/{model.replace('/', '_')}/{output_prefix}_{model.replace('/', '_')}_temp{temperature}.jsonl"
